...
class Factura(models.Model):
    ...
    Id_FormaPago=models.ForeignKey(FormaPago, verbose_name='Forma de oago',null=False, blank=False, on_delete=models.PROTECT)
    ...
    Codigo_CAI=models.CharField(max_length=35, verbose_name='Codigo CAI')
